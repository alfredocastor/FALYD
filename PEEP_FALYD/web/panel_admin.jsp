...
<body>
    ...
    <div class="main-content">
        ...
        <h5 class="fw-bold mb-3">Últimos Accesos y Actividad</h5>
        <div class="row g-4 mb-5">
            <div class="col-md-6">
                <div class="card-custom">
                    <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                        <img src="https://ui-avatars.com/api/?name=J+G&background=random" class="rounded-circle me-3" width="40">
                        <div class="flex-grow-1">
                            <h6 class="fw-bold mb-0 text-dark">jgarcia</h6>
                            <p class="text-muted small mb-0">Alumno</p>
                        </div>
                        <i class="bi bi-check-circle-fill text-success fs-5"></i>
                    </div>
                    <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                        <img src="https://ui-avatars.com/api/?name=M+P&background=random" class="rounded-circle me-3" width="40">
                        <div class="flex-grow-1">
                            <h6 class="fw-bold mb-0 text-dark">mperez</h6>
                            <p class="text-muted small mb-0">Maestro</p>
                        </div>
                        <i class="bi bi-check-circle-fill text-success fs-5"></i>
                    </div>
                    <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                        <img src="https://ui-avatars.com/api/?name=A+L&background=random" class="rounded-circle me-3" width="40">
                        <div class="flex-grow-1">
                            <h6 class="fw-bold mb-0 text-dark">alopez</h6>
                            <p class="text-muted small mb-0">Secretaría</p>
                        </div>
                        <i class="bi bi-check-circle-fill text-success fs-5"></i>
                    </div>
                    <div class="text-center mt-3">
                        <a href="#" class="btn btn-light fw-bold text-muted border px-4 rounded-pill small">Ver más <i class="bi bi-chevron-right small"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card-custom">
                    <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                        <div class="me-3 text-success fs-4"><i class="bi bi-check-circle-fill"></i></div>
                        <div>
                            <h6 class="fw-bold mb-0 text-dark">Backup del sistema completado</h6>
                    ...
                    <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                        <div class="me-3 text-success fs-4"><i class="bi bi-check-circle-fill"></i></div>
                        <div>
                            <h6 class="fw-bold mb-0 text-dark">Nuevo maestro agregado: Carlos Ruiz</h6>
                            <p class="text-muted small mb-0">Hace 5 horas</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                        <div class="me-3 text-success fs-4"><i class="bi bi-check-circle-fill"></i></div>
                        <div>
                            <h6 class="fw-bold mb-0 text-dark">Actualización de grupo 3°A</h6>
                            <p class="text-muted small mb-0">Ayer</p>
                        </div>
                    </div>
                    <div class="text-center mt-3">
                        <a href="#" class="btn btn-light fw-bold text-muted border px-4 rounded-pill small">Ver más <i class="bi bi-chevron-right small"></i></a>
