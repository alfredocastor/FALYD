...
<head>
    ...
    <title>Panel de Administración - FALYD</title>
...
<body>
    ...
    <div class="sidebar d-flex flex-column">
        ...
        <nav class="nav flex-column mt-3">
            ...
            <a class="nav-link" href="#"><i class="bi bi-person-badge me-2"></i> Maestros</a>
    ...
    <div class="main-content">
        ...
        <div class="row g-4 mb-5">
            <div class="col-md-3">
                <div class="card card-custom p-4 border-bottom border-primary border-4">
                    <h6 class="text-muted">Total Alumnos</h6>
                    <h2 class="fw-bold">450</h2>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card card-custom p-4 border-bottom border-success border-4">
                    <h6 class="text-muted">Total Maestros</h6>
                    <h2 class="fw-bold">24</h2>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card card-custom p-4 border-bottom border-warning border-4">
                    <h6 class="text-muted">Grupos Activos</h6>
                    <h2 class="fw-bold">15</h2>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card card-custom p-4 border-bottom border-danger border-4">
                    <h6 class="text-muted">Alertas del Sistema</h6>
