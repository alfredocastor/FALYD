...
<head>
    ...
    <style>
        ...
        .table-container { background: white; border-radius: 20px; padding: 25px; box-shadow: 0 4px 15px rgba(0,0,0,0.02); }
        .table { margin-bottom: 0; }
        .table thead th { border-bottom: 2px solid var(--border-color); color: #8f9bba; font-weight: 600; font-size: 0.85rem; padding-bottom: 15px; text-transform: uppercase; letter-spacing: 0.5px; }
        .table tbody td { vertical-align: middle; padding: 15px 10px; border-bottom: 1px solid #f1f5f9; color: var(--text-main); font-weight: 500; font-size: 0.95rem; }
        ...
        .btn-icon { background: #f8fafc; border: 1px solid var(--border-color); color: var(--blue-falyd); width: 35px; height: 35px; border-radius: 8px; display: inline-flex; align-items: center; justify-content: center; transition: 0.2s; text-decoration: none; }
        .btn-icon:hover { background: #e3f2fd; border-color: #bbdefb; color: var(--blue-falyd); }
    </style>
</head>
<body>
