                    ...
                    <form action="AlumnoServlet" method="POST">
                        <div class="modal-body p-4">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control bg-light border-0 p-2.5" name="password" placeholder="Mínimo 6 caracteres" minlength="6" required style="border-radius: 10px;">                        </div>
