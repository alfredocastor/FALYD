    ...
    <head>
      ...
      <body class="d-flex align-items-center min-vh-100">
            ...
            <div class="row align-items-center justify-content-center gap-5">
                ...
                <div class="col-md-5 text-center text-md-start mb-5 mb-md-0" style="transform: translateY(-90px);">
                    ...
                    <div class="card login-card p-4">
                        <div class="card-body">
                            ...
                            <div class="alert alert-danger py-2 small text-center mb-4" role="alert">
                                <i class="bi bi-exclamation-triangle-fill me-2"></i> Credenciales incorrectas. Intenta de nuevo.
                            </div>
                            <% }%>
                            ...
                            <form action="LoginServlet" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text" style="color: #0b3b60;"><i class="bi bi-envelope-fill"></i></span>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="password" id="txtPassword" class="form-control input-with-icon" name="password" placeholder="Ingresa tu contraseña" required>
                                        <button class="input-group-text btn-toggle-pass" type="button" id="btnTogglePassword">
